        ...
        <div class="card-body">
            <form action="{{ route('article.store') }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input onkeyup="ChangeToSlug();" type="text" id="name" name="title" class="form-control">
                </div>
                ...
                <div class="form-group">
                    <div class="mt-2">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="customRadio3" value="0" name="status" class="custom-control-input">
